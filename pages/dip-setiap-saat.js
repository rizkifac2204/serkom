...
const DipSetiapSaat = () => {
  ...
  const {
    ...
    queryKey: ["public", "dips", "setiap-saat", filter],
    queryFn: ({ signal }) =>
      axios
        .get(`/api/public/dip/setiap-saat`, { signal, params: filter })
        .then((res) => {
        ...
        <div className="background-top">
          <div className="item-title">
            <h2>
              ...
              <br />
              <span className="point">.DIP</span> Tersedia Setiap Saat
            </h2>
            <p>Informasi Tersedia Setiap Saat</p>
          </div>
          {/* .item-title */}
          <button
...
DipSetiapSaat.public = true;
export default DipSetiapSaat;
