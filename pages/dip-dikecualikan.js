...
const DipDikecualikan = () => {
  ...
  const {
    ...
    queryKey: ["public", "dips", "dikecualikan", filter],
    queryFn: ({ signal }) =>
      axios
        .get(`/api/public/dip/dikecualikan`, { signal, params: filter })
        .then((res) => {
        ...
        <div className="background-top">
          <div className="item-title">
            <h2>
              ...
              <br />
              <span className="point">.DIP</span> Dikecualikan
            </h2>
            <p>Informasi yang dikecualikan</p>
          </div>
          {/* .item-title */}
          <button
...
DipDikecualikan.public = true;
export default DipDikecualikan;
