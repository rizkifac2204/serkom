...
const DipSertaMerta = () => {
  ...
  const {
    ...
    queryKey: ["public", "dips", "serta-merta", filter],
    queryFn: ({ signal }) =>
      axios
        .get(`/api/public/dip/serta-merta`, { signal, params: filter })
        .then((res) => {
        ...
        <div className="background-top">
          <div className="item-title">
            <h2>
              ...
              <br />
              <span className="point">.DIP</span> Serta Merta
            </h2>
...
DipSertaMerta.public = true;
export default DipSertaMerta;
